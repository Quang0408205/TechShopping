...
/**
 * Access tokens are HS256 JWTs signed with app.jwt.secret (Spring Security OAuth2 resource server + Nimbus).
 * The "roles" claim holds role names such as CUSTOMER and becomes ROLE_CUSTOMER authorities.
 */
@Configuration
